This repository contains Deadly Dodgeball, my submission for the Ubisoft Toronto Next programming challenge, in which contestannts had 3 days to create a game in C++ using the provided API and no additional libraries.
...
To play the game clone the repo to your device, open the GameTest.sln file and run the game.
